  ...
  <div>
    <q-page class="q-pa-xl">
      ...
      <section class="q-mb-xl">
        ...
        <q-separator class="q-my-md" />
        <div class="ellipsis">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores, rerum! Recusandae
          officia, sapiente minus illum repellat odit laboriosam laborum earum assumenda quae ad
          nisi totam quod quibusdam eveniet, saepe soluta.
        </div>
        <hr />
