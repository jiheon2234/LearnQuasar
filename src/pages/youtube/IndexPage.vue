    ...
    <section class="content">
      <div class="row q-col-gutter-x-md q-col-gutter-y-xl">
        <div v-for="n in 16" :key="n" class="col-12 col-sm-6 col-md-4 col-lg-3">
          <article>
            <q-img :ratio="16 / 9" src="https://cdn.quasar.dev/img/mountains.jpg" />
            <div class="row q-col-gutter-x-sm q-mt-md">
              ...
              <div class="col">
                <div class="text-subtitle1 text-weight-bold" :style="{ lineHeight: '1.1em' }">
                  퀘이사 강의 | Quasar Lecture
                </div>
                <div class="text-caption text-grey-9">HELLO WORLD</div>
              </div>
            </div>
          </article>
        </div>
...
const filters = ref(['전체', '실시간', '게임', '음악', '스포츠']);
</script>
